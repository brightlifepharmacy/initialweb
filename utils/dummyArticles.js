module.exports = [
  {
    id: 1,
    title: "Understanding Allopathic Medicines",
    description: "Learn how common prescription medicines work and how to use them safely.",
    content: [
      "Allopathic medicines are modern, evidence-based medicines used to treat symptoms, manage chronic conditions, and support recovery from illness.",
  ...
  },
  {
    ...
    description: "A practical checklist of must-have supplies for quick emergency care.",
    content: [
      "A good first aid kit helps you respond quickly to minor cuts, burns, sprains, and sudden discomfort before professional care is available.",
  ...
  {
    id: 3,
    title: "Safe Use of Surgical Supplies",
    description: "Simple hygiene and storage tips for gloves, masks, and basic surgical items.",
    content: [
      "Surgical supplies should be handled with clean hands and stored in sealed packaging until use to reduce contamination.",
  ...
  {
    id: 4,
    title: "Monitoring Blood Pressure at Home",
    description: "Know when and how to check blood pressure for more reliable readings.",
    content: [
      "Home blood pressure monitoring can help track health trends, especially for people managing hypertension or heart-related risks.",
